...
<?php startblock('body') ?>
    <form method="post" action="validate-login.php">
        <input id="usr" name="username" required="true" type="text" placeholder="Gebruikersnaam">
        <input id="psw" name="password" required="true" type="password" placeholder="Wachtwoord">
